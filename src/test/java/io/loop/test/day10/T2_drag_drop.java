...
public class T2_drag_drop {
    ...
    public void drag_drop_test() {
        ...
        WebElement perfectMsg = Driver.getDriver().findElement(By.xpath("//a[text()='Perfect!']"));

       String expectedText = "Perfect!";
       String actualText = perfectMsg.getText();

       assertEquals(actualText, expectedText, "NO MATCH");
       assertTrue(perfectMsg.isDisplayed(), "No msg");
